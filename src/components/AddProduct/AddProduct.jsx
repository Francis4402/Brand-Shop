        ...
        <form onSubmit={handleAddProduct} className="space-y-8">
            <div className="sm:flex grid gap-5">
                ...
                <div className="form-control">
                  ...
                  <input name="photo" type="url" placeholder="ImageURL" className="input input-bordered" />
                </div>
                <div className="form-control">
                  <label className="label">
              ...
              <div className="grid h-fit gap-3">
                ...
                <div className="form-control">
                  ...
                  <input name="shortdescription" type="text" placeholder="Description" className="input input-bordered" />
                </div>
                ...
                <div className="form-control">
                  ...
                  <select name="rating" className="p-4 rounded-md bg-base-300" required>
