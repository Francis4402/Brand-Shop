...
const Displaynokiaphone = ({movedata, datadelete, setdataDelete}) => {
    ...
    const handleDelete = (productId) => {
      ...
      .then(result => {
        if(result.isConfirmed){
          fetch(`https://brand-shopserve-side-francisms-projects.vercel.app/mobiles/nokiam/${productId}`,{
            method: 'DELETE'
          })
          .then(res => res.json())
          .then(data => {
