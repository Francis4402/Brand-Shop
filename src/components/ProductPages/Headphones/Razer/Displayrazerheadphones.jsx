...
const Displayrazerheadphones = ({movedata, datadelete, setdataDelete}) => {
    ...
    const handleDelete = (productId) => {
      ...
      .then(result => {
        if(result.isConfirmed){
          fetch(`https://ecombackend-production-1c34.up.railway.app/headphones/razerH/${productId}`,{
            method: 'DELETE'
          })
          .then(res => res.json())
          .then(data => {
